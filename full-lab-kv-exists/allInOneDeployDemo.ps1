...
New-AzSubscriptionDeployment -Name $allInOneDeploymentName -TemplateFile $allInOneBicepFile -verbose -connectivityRGLocation $connectivityRGLocation -subID $subID -Location $deployLocation -identityRGLocation $identityRGLocation -objectID $objectID -tenantID $tenantID -keyVaultRGLocation $keyVaultRGLocation -prefix $prefix
