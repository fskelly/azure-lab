...
New-AzSubscriptionDeployment -Name $allInOneDeploymentName -TemplateFile $allInOneBicepFile #-connectivityRGLocation $connectivityRGLocation -verbose #-subID $subID -verbose -Location $identityRGLocation
